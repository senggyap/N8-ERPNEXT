/* NKT CURRENT CLIENT SCRIPT — NKT Warehouse Change Fast Screen — Form
...
/* ===== SOURCE: NKT Warehouse Change Fast Screen V2.0C.4.2.2 ===== */
(() => {
...
/* ===== END SOURCE: NKT Warehouse Change Fast Screen V2.0C.4.2.2 ===== */

/* ===== SOURCE: NKT R4 UI6 Reserved F1 F7 - NKT Warehouse Change Fast Screen ===== */
// NKT R4 UI6 - reserve F1 and F7 on this NKT Fast Screen.
(() => {
    const DOCTYPE = "NKT Warehouse Change Fast Screen";
    const SLOT = "__nktReservedF1F7_2d65ad325c3563be";
...
/* ===== END SOURCE: NKT R4 UI6 Reserved F1 F7 - NKT Warehouse Change Fast Screen ===== */
